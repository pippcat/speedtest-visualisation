...
def preparePlot(name, interval):
	...
	plotname.x_range.start = (time.time()-interval)*1000
	plotname.x_range.end = time.time()*1000+7200
	return plotname
...
p_download = preparePlot("Download", INTERVAL)
...
p_upload = preparePlot("Upload", INTERVAL)
# calculating average values
...
p_internal = preparePlot("Internal", INTERVAL)
# calculating average values
...
p_ping = preparePlot("Ping", INTERVAL)
